...
<div class="main">
	...
	<div class="login-form">
			...
			%>
				<h1>
					<label>User Name</label> <input type="text" class="form-control"
						placeholder="User Name" name="input_id" required autofocus>
				</h1>
			</div>
			<div class="form-group">
				<h1>
					<label>Password</label> <input type="password" class="form-control"
						placeholder="Password" name="input_pw" required>
				</h1>
			</div>
			<h2>
		...
		<h2>
			...
			<button onClick="location.href='register.jsp'" class="btn btn-secondary">Register</button>
